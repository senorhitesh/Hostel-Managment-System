...
const EmployeeDashboad = ({ data }) => {
  return (
    <div className="h-screen max-w-6xl mx-auto py-2 relative">
      <HeaderED data={data} />
      <div className="mt-8">
        <TaskCard data={data} />
      </div>
      <div className=" m-4 flex flex-col gap-4 p-4 rounded-xl border relative border-gray-300 bg-gray-100">

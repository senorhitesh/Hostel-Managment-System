...
const EmployeeDashboad = () => {
  return (
    <div className="h-screen max-w-6xl mx-auto py-2">
      ...
      <div className=" m-4">
        <div className="w-full bg-[#FFFFF0]  shadow-lg border-1 border-transparent transtion-all duration-150 hover:shadow-2xl hover:scale-101 hover:bg-gray-100 hover:border-gray-300  p-4 rounded-xl active:scale-99">

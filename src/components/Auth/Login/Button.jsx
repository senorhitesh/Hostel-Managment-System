...
const Button = ({onClick}) => {
  return (
    <>
      <button
      className="cursor-pointer mt-2 bg-[#111] text-white py-3 rounded-md hover:bg-black/90 transtion-all shadow-md hover: duration-150 active:scale-98 hover:-translate-y-0.5 shadow-[0px_4px_32px_0_rgba(99,102,241,.70)] group group/arrow">
